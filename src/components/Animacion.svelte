<script>
    ...
    const url = `https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=es-ES&with_genres=16`;
...
<section>
    <h1 class="genre">Animación</h1>
    <div class="swiper">
        <div class="swiper-wrapper">
            {#each movies as movie}
                <img class="swiper-slide" src={`https://image.tmdb.org/t/p/original/${movie.poster_path}`} alt={movie.title}/>
            {/each}
        </div>
    </div>
</section>
